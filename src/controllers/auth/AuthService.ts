...
export class AuthService {
    ...
    async register(createUserDto: { email: string; password: string; roles: string }): Promise<{ token: string, user: IUser }> {
        try {
    ...
    async login(createUserDto: LoginDto): Promise<{ token: string, user: IUser }> {
        try {
